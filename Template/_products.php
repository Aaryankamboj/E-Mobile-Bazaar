 ...
 <section id="product" class="py-3">
            <div class="container">
                <div class="row">
                    <div class="col-sm-6">
                        <img src="./Mobile Phone Images/6.png" alt="product" class="img-fluid">
                    ...
                    <div class="col-sm-6 py-5">
                        <h5 class="font-size-20 font-Ubuntu">Samsung Galaxy F42 5G</h5>
                        <small class="font-Krub"> by Samsung</small>
                        <div class="d-flex">
                        ...
                        <table class="my-3">
                            ...
                            <tr class="font-Krub font-size-14">
                                <td>Deal Price</td>
                                <td class="font-size-20 text-danger">&nbsp; &#x20B9; <span>20,999</span> <small
                                        class="font-size-14 text-dark">(inclusive of all taxes)</small> </td>
                            </tr>

                            <tr class="font-Krub font-size-14">
                                <td>You Save</td>
                                <td class="text-danger">&nbsp; &#x20B9; <span
                                        class="font-size-14 text-danger">1,999</span></td>
                            </tr>
                        </table>
                            ...
                            <div class="col-6">
                                ...
                                <div class="color my-3">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="bg-primary rounded-circle"> <button
                                                class="btn font-size-12"></button> </div>
                                        <div class="bg-danger rounded-circle"> <button
                                                class="btn font-size-12"></button> </div>
                                    </div>
                                </div>
                                <!-- !Color ends here-->
                            ...
                            <div class="col-6">
                                ...
                                <div class="qty d-flex">
                                    ...
                                    <div class="d-flex px-4 font-Rale">
                                        ...
                                        <input type="text"  data-id="pro1" class="qty_input border px-2 w-50 bg-light font-Ubuntu" disabled
