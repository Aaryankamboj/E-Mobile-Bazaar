<?php
    $main_shuffle=$product->getData();

    // To add a new button automatically when a new product is added
    $brand=array_map(function($pro){return $pro['item_brand'];}, $main_shuffle);
            ...
            <div class="grid-item border <?php echo $item['item_brand'] ?? "Brand"; ?>  ">
                <div class="item py-2 " style="width: 200px;">
                    <div class="product font-Rubik">
                        <a href=""><img src="<?php echo $item['item_image'] ?? "./Mobile Phone Images/13.png" ?>" alt="product1" class="img-fluid"> </a>
